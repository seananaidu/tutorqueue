 ...
 */
// this should be whatever now
/**
 * @Configuration Error reporting
 * @Description Show every problem during development.
 *  Only shows hard / no errors in production. For development purposes.
 */
error_reporting(E_ALL);
ini_set("display_errors", 1);

/**
 * @Configuration Cookie Security
 * @Description Marks the cookie as accessible only through the HTTP protocol.
 *  (PHP Manual reference) This means that the cookie won't be accessible by
 *  scripting languages, such as JavaScript. This setting can effectively help
 *  to reduce identity theft through XSS attacks (although it is not
...
/**
 * Returns the full configuration. This is used by the core/Config class.
 */
return array(
